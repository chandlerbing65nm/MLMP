...
#SBATCH --output=logs/dutuseg5/output_%j.txt
...
mkdir -p logs/dutuseg5

# # ========== SOURCE ==========
# python main.py \
#     --ovss_type naclip \
#     --ovss_backbone ViT-B/16 \
#     --save_dir .save/DUTUSEG5Dataset/No_Adaptation/ \
#     --data_dir /scratch/project_465002853/datasets/dut-useg/DUT-USEG/ \
#     --dataset DUTUSEG5Dataset \
#     --workers 4 \
#     --init_resize 224 224 \
#     --patch_size 224 224 \
#     --patch_stride 112 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-B/16 \
#     --save_dir .save/DUTUSEG5Dataset/tent/ \
#     --data_dir /scratch/project_465002853/datasets/dut-useg/DUT-USEG/ \
#     --dataset DUTUSEG5Dataset \
#     --workers 4 \
#     --init_resize 224 224 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-B/16 \
#     --save_dir .save/DUTUSEG5Dataset/watt/ \
#     --data_dir /scratch/project_465002853/datasets/dut-useg/DUT-USEG/ \
#     --dataset DUTUSEG5Dataset \
#     --workers 4 \
#     --init_resize 224 224 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-B/16 \
#     --save_dir .save/DUTUSEG5Dataset/clipartt/ \
#     --data_dir /scratch/project_465002853/datasets/dut-useg/DUT-USEG/ \
#     --dataset DUTUSEG5Dataset \
#     --workers 4 \
#     --init_resize 224 224 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-B/16 \
#     --save_dir .save/DUTUSEG5Dataset/mlmp/ \
#     --data_dir /scratch/project_465002853/datasets/dut-useg/DUT-USEG/ \
#     --dataset DUTUSEG5Dataset \
#     --workers 4 \
#     --init_resize 224 224 \
