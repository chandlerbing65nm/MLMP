...
#SBATCH --output=logs/suim5/output_%j.txt
...
#     --save_dir .save/SUIM5Dataset/No_Adaptation/ \
#     --data_dir /scratch/project_465002853/datasets/suim/SUIM/ \
#     --dataset SUIM5Dataset \
#     --workers 4 \
#     --init_resize 320 256 \
#     --patch_size 224 224 \
#     --patch_stride 112 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-L/14 \
#     --save_dir .save/SUIM5Dataset/tent/ \
#     --data_dir /scratch/project_465002853/datasets/suim/SUIM/ \
#     --dataset SUIM5Dataset \
#     --workers 4 \
#     --init_resize 320 256 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-L/14 \
#     --save_dir .save/SUIM5Dataset/watt/ \
#     --data_dir /scratch/project_465002853/datasets/suim/SUIM/ \
#     --dataset SUIM5Dataset \
#     --workers 4 \
#     --init_resize 320 256 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-L/14 \
#     --save_dir .save/SUIM5Dataset/clipartt/ \
#     --data_dir /scratch/project_465002853/datasets/suim/SUIM/ \
#     --dataset SUIM5Dataset \
#     --workers 4 \
#     --init_resize 320 256 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-L/14 \
#     --save_dir .save/SUIM5Dataset/mlmp/ \
#     --data_dir /scratch/project_465002853/datasets/suim/SUIM/ \
#     --dataset SUIM5Dataset \
#     --workers 4 \
#     --init_resize 320 256 \
