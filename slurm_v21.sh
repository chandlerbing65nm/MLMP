...
#SBATCH --output=logs/voc21/output_%j.txt
...
#     --save_dir .save/PascalVOC21Dataset/No_Adaptation/ \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-B/16 \
#     --save_dir .save/PascalVOC21Dataset/tent/ \
#     --data_dir /scratch/project_465002853/datasets/VOCdevkit/VOC2012/ \
#     --dataset PascalVOC21Dataset \
#     --workers 4 \
#     --init_resize 224 224 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-B/16 \
#     --save_dir .save/PascalVOC21Dataset/watt/ \
#     --data_dir /scratch/project_465002853/datasets/VOCdevkit/VOC2012/ \
#     --dataset PascalVOC21Dataset \
#     --workers 4 \
#     --init_resize 224 224 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-B/16 \
#     --save_dir .save/PascalVOC21Dataset/clipartt/ \
#     --data_dir /scratch/project_465002853/datasets/VOCdevkit/VOC2012/ \
#     --dataset PascalVOC21Dataset \
#     --workers 4 \
#     --init_resize 224 224 \
...
#     --ovss_type naclip \
#     --ovss_backbone ViT-B/16 \
#     --save_dir .save/PascalVOC21Dataset/mlmp/ \
#     --data_dir /scratch/project_465002853/datasets/VOCdevkit/VOC2012/ \
#     --dataset PascalVOC21Dataset \
#     --workers 4 \
#     --init_resize 224 224 \
...
python main.py \
    ...
    --loss_src_cons True --lamb_src_cons 1.0 \
    --updownsample 1.0 \
